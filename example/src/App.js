  ...
  return (
    <section dir={rtl ? 'rtl' : 'ltr'} style={{maxWidth: '400px', display: 'flex', flexDirection: 'column', 
      ...
      <div style={{maxWidth: '100%', display: 'flex', flexDirection: 'column', alignItems: 'stretch', gap: '0.25rem', padding: '1rem', border: '1px solid blue'}} >
        ...
        <QuestionInputFloatingLabel className='' title='Layout Direction' dark={darkMode}
      ...
      <NormalInputFloatingLabel className='' label='Simple Input' type='text' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          value={simpleData} onChangeValue={(val) => setSimpleData(val)} labelType={labelType ? '1' : '2'} />
      <NormalInputFloatingLabel className='' label='Simple Input (integer)' type='IntNumber' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          value={simpleDataInt} onChangeValue={(val) => setSimpleDataInt(val)} labelType={labelType ? '1' : '2'} />
      <NormalInputFloatingLabel className='' label='Simple Input (float)' type='FloatNumber' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          value={simpleDataFloat} onChangeValue={(val) => setSimpleDataFloat(val)} labelType={labelType ? '1' : '2'} />
      <NormalInputFloatingLabel className='' label='Simple Input (Custom icon)' type='text' disabled={disableAll} minHeight={minHeight} dark={darkMode}
      ...
      <DateInputFloatingLabel className='' label='Date Input (Shamsi)' disabled={disableAll} shamsiMode={true} minHeight={minHeight} dark={darkMode}
          value={dateDataShamsi} onChangeValue={(val) => setDateDataShamsi(val)} labelType={labelType ? '1' : '2'} />
      <DateInputFloatingLabel className='' label='Date Input (Persian)' disabled={disableAll} shamsiMode={true} persianLanguage={true} minHeight={minHeight} dark={darkMode}
          value={dateDataPersian} onChangeValue={(val) => setDateDataPersian(val)} labelType={labelType ? '1' : '2'} />
      <DateInputFloatingLabel className='' label='Date Input (Gregorian)' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          value={dateDataEnglish} onChangeValue={(val) => setDateDataEnglish(val)} labelType={labelType ? '1' : '2'} />
      <DateInputFloatingLabel className='' label='Date Input (With icon)' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          value={dateDataIcon} onChangeValue={(val) => setDateDataIcon(val)} hasIcon={true} labelType={labelType ? '1' : '2'} />
      <DateInputFloatingLabel className='' label='Date Input (Custom icon)' disabled={disableAll} minHeight={minHeight} dark={darkMode}
      ...
      <EmailInputFloatingLabel className='' label='Email Input' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight} dark={darkMode}
          value={emailData} onChangeValue={(val) => setEmailData(val)} />
      <EmailInputFloatingLabel className='' label='Email Input (Validate)' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight} dark={darkMode}
          value={emailDataValiate} onChangeValue={(val) => setEmailDataValiate(val)} onValidate={(e) => console.log(e)} />
      <EmailInputFloatingLabel className='' label='Email Input (With icon)' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight} dark={darkMode}
        value={emailDataIcon} onChangeValue={(val) => setEmailDataIcon(val)} hasIcon={true} />
      <EmailInputFloatingLabel className='' label='Email Input (Custom icon)' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight} dark={darkMode}
      ...
      <PasswordInputFloatingLabel className='' label='Password Input' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight} dark={darkMode}
          value={passwordData} onChangeValue={(val) => setPasswordData(val)} />
      <PasswordInputFloatingLabel className='' label='Password Input (With icon)' disabled={disableAll} hasIcon={true} minHeight={minHeight} dark={darkMode}
          value={passwordDataIcon} onChangeValue={(val) => setPasswordDataIcon(val)} labelType={labelType ? '1' : '2'} />

      <NormalInputFloatingLabel className='' lineCount='7' label='Multi-Line Input' type='text' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          value={multiLineData} onChangeValue={(val) => setMultiLineData(val)} labelType={labelType ? '1' : '2'} />

      <SelectInputFloatingLabel className='' label='Select Input' disabled={disableAll} colorPrimary='#0d6efd' minHeight={minHeight} dark={darkMode}
      ...
      <PhoneInputFloatingLabel className='' label='Phone Input (Country value code)' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight}
          countryValue={phoneData.mobileCountryCode} phoneValue={phoneData.mobileValue} dark={darkMode}
      ...
      <PhoneInputFloatingLabel className='' label='Phone Input (Country dial code)' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight} useDialCode={true}
          countryValue={phoneDataDC.mobileCountryCode} phoneValue={phoneDataDC.mobileValue} dark={darkMode}
      ...
      <PhoneInputFloatingLabel className='' label='Phone Input (Validate)' disabled={disableAll} labelType={labelType ? '1' : '2'} minHeight={minHeight}
          countryValue={phoneDataValidate.mobileCountryCode} phoneValue={phoneDataValidate.mobileValue} dark={darkMode}
      ...
      <QuestionInputFloatingLabel className='' title='Question Input' disabled={disableAll} minHeight={minHeight} dark={darkMode}
          trueOption='Yes' falseOption='No'
          value={questionData} onChangeValue={(val) => setQuestionData(val)} />

      <CheckBoxInputFloatingLabel className = '' text='Check Box Input' disabled={disableAll} minHeight={minHeight} dark={darkMode}
