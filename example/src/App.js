...
const App = () => {
  ...
  return (
    <section style={{maxWidth: '400px', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginLeft: 'auto', marginRight: 'auto', alignItems: 'stretch'}}>
      ...
      <DateInputFloatingLabel className='' label='Date Input (Persian)' disabled={disableAll} persianMode={true}
          value={dateDataPersian} onChangeValue={(val) => setDateDataPersian(val)} />
      <DateInputFloatingLabel className='' label='Date Input (Gregorian)' disabled={disableAll}
        value={dateDataEnglish} onChangeValue={(val) => setDateDataEnglish(val)} />
      <DateInputFloatingLabel className='' label='Date Input (With icon)' disabled={disableAll}
          value={dateDataIcon} onChangeValue={(val) => setDateDataIcon(val)} hasIcon={true} />
      <DateInputFloatingLabel className='' label='Date Input (Custom icon)' disabled={disableAll}
          value={dateDataCustomIcon} onChangeValue={(val) => setDateDataCustomIcon(val)} hasIcon={true}
      ...
      <EmailInputFloatingLabel className='' label='Email Input' disabled={disableAll}
          value={emailData} onChangeValue={(val) => setEmailData(val)} />
      <EmailInputFloatingLabel className='' label='Email Input (Validate)' disabled={disableAll}
          value={emailDataValiate} onChangeValue={(val) => setEmailDataValiate(val)} onValidate={(e) => console.log(e)} />
      <EmailInputFloatingLabel className='' label='Email Input (With icon)' disabled={disableAll}
        value={emailDataIcon} onChangeValue={(val) => setEmailDataIcon(val)} hasIcon={true} />
      <EmailInputFloatingLabel className='' label='Email Input (Custom icon)' disabled={disableAll}
      ...
      <PasswordInputFloatingLabel className='' label='Password Input' disabled={disableAll}
          value={passwordData} onChangeValue={(val) => setPasswordData(val)} />
      <PasswordInputFloatingLabel className='' label='Password Input (With icon)' disabled={disableAll} hasIcon={true}
          value={passwordDataIcon} onChangeValue={(val) => setPasswordDataIcon(val)} />

      <NormalInputFloatingLabel className='' lineCount='7' label='Multi-Line Input' type='text' disabled={disableAll}
          value={multiLineData} onChangeValue={(val) => setMultiLineData(val)} />

      <SelectInputFloatingLabel className='' label='Select Input' disabled={disableAll} colorPrimary='#0d6efd'
      ...
      <PhoneInputFloatingLabel className='' label='Phone Input' disabled={disableAll}
      ...
      <PhoneInputFloatingLabel className='' label='Phone Input (Validate)' disabled={disableAll}
      ...
      <QuestionInputFloatingLabel className='' title='Question Input' disabled={disableAll}
